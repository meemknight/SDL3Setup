...
This is a CMake setup that loads SDL3, stb_image, stb_truetype, and a custom 2d library.
It is a port of https://github.com/meemknight/cmakeSetup to SDL3 in an effort to make a cross platform game framework. Because it uses SDL3 it should port to EVERY platform with ease!
